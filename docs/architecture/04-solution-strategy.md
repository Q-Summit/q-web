...
| Compliant by construction | No cookies / no third-party CDNs today; PostHog EU cookieless when the client ships ([ADR-0003](../decisions/0003-posthog-cookieless-analytics.md)); self-hosted assets; EU database region; legal pages on the site | [ADR-0002](../decisions/0002-payload-cms-on-vercel-neon.md), [ADR-0003](../decisions/0003-posthog-cookieless-analytics.md), rules in [section 8](08-concepts.md) |
